...
<a name="0.44.0"></a>
# [0.44.0](https://github.com/kaltura/playkit-js/compare/v0.43.1...v0.44.0) (2018-08-15)


### Features

* test only if master push or tag or PR ([#6](https://github.com/kaltura/playkit-js/issues/6)) ([e7b3393](https://github.com/kaltura/playkit-js/commit/e7b3393))
...
* test new travis conditions v1 ([a8fb520](https://github.com/kaltura/playkit-js/commit/a8fb520))



<a name="0.42.0"></a>
# [0.42.0](https://github.com/kaltura/playkit-js/compare/v0.41.5...v0.42.0) (2018-08-15)


### Features

* don't run release task on tag ([52a403c](https://github.com/kaltura/playkit-js/commit/52a403c))



<a name="0.41.5"></a>
## [0.41.5](https://github.com/kaltura/playkit-js/compare/v0.41.4...v0.41.5) (2018-08-15)


### Bug Fixes

* travis build fail ([6481f32](https://github.com/kaltura/playkit-js/commit/6481f32))



<a name="0.41.4"></a>
## [0.41.4](https://github.com/kaltura/playkit-js/compare/v0.41.3...v0.41.4) (2018-08-15)


### Bug Fixes

* deploy on tag from master ([593590f](https://github.com/kaltura/playkit-js/commit/593590f))



<a name="0.41.3"></a>
## [0.41.3](https://github.com/kaltura/playkit-js/compare/v0.41.2...v0.41.3) (2018-08-14)


### Bug Fixes

* build script fail ([5421db3](https://github.com/kaltura/playkit-js/commit/5421db3))



<a name="0.41.2"></a>
## [0.41.2](https://github.com/kaltura/playkit-js/compare/v0.41.1...v0.41.2) (2018-08-14)


### Bug Fixes

* travis release fail ([2a96445](https://github.com/kaltura/playkit-js/commit/2a96445))



<a name="0.41.1"></a>
## [0.41.1](https://github.com/kaltura/playkit-js/compare/v0.41.0...v0.41.1) (2018-08-14)


### Bug Fixes

* release on tag ([49a6f33](https://github.com/kaltura/playkit-js/commit/49a6f33))
...
* publishing to npm not working ([b1afce4](https://github.com/kaltura/playkit-js/commit/b1afce4))
...
* add NPM and release canary flow ([c589cd2](https://github.com/kaltura/playkit-js/commit/c589cd2))
...
* add release notes to tag message ([2b86b56](https://github.com/kaltura/playkit-js/commit/2b86b56))



<a name="0.37.0"></a>
# [0.37.0](https://github.com/kaltura/playkit-js/compare/v0.36.5...v0.37.0) (2018-08-01)


### Features

* add changelog to tag commit message ([187e1df](https://github.com/kaltura/playkit-js/commit/187e1df))
